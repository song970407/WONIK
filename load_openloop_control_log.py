...
def main(is_control_TC,
    ...
    if smooth_u_type == 'penalty':
        u_range = 0
    if is_control_TC:
        dir = 'control_log_simulation/multistep_linear_residual_with_control_TC/residual_{}_{}_{}_{}/{}_{}_{}_{}_{}_{}_{}'.format(
            state_order, action_order, training_H, training_alpha, control_scheme, smooth_u_type, alpha, u_range,
            optimizer_mode,
            initial_solution, max_iter)
    else:
        dir = 'control_log_simulation/multistep_linear_residual_without_control_TC/residual_{}_{}_{}_{}/{}_{}_{}_{}_{}_{}_{}'.format(
            state_order, action_order, training_H, training_alpha, control_scheme, smooth_u_type, alpha, u_range,
            optimizer_mode,
            initial_solution, max_iter)
    ...
    if not os.path.exists(fig_dir):
        os.makedirs(fig_dir)
    fig.suptitle('Model: {}_{}_{}_{}, Control: {}_{}_{}_{}_{}_{}_{}'.format(state_order, action_order, training_H, training_alpha,control_scheme, smooth_u_type, alpha, u_range, optimizer_mode, initial_solution, max_iter))
    fig.savefig(
        fig_dir + '/{}_{}_{}_{}_{}_{}_{}_control_result.png'.format(control_scheme, smooth_u_type, alpha, u_range, optimizer_mode, initial_solution, max_iter))
    fig.show()
...
if __name__ == '__main__':
    ...
    control_scheme = 'openloop'  # MPC or openloop
    ...
    max_iters = [500]  # Maximum number of optimizer iterations
